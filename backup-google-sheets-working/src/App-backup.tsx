...
const App = () => {
  ...
  const handleStateSelect = useCallback((state: string) => {
    ...
    // DIRECT APPROACH: If New Jersey is selected, immediately render Humble Road
    if (state === 'New Jersey') {
      console.log('New Jersey selected - DIRECT APPROACH');
      
      // Create Humble Road builder
      const humbleRoad = {
        id: 'nj-1',
        name: 'Humble Road',
        address: 'Brick, NJ 08723',
      ...
      // Directly set the builders and filtered builders
      ...
      console.log('Humble Road builder set directly:', humbleRoad);
      return;
    }
